...
python3 archive.py wikimedia-dumps-urls.txt force #force because sometimes dump is in progress
...
python3 archive.py wikimedia-dumps-urls.txt #force not needed, just save once
