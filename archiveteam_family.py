# -*- coding: utf-8  -*-
"""Family module for ArchiveTeam wiki."""
...
"""
This file is needed to run bots over ArchiveTeam wiki
Save it in directory "pywikibot/families"
"""

# The MediaWiki family
# user-config.py: usernames['archiveteam']['archiveteam'] = 'User name'
class Family(family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.name = 'archiveteam'

        self.langs = {
            'archiveteam': 'www.archiveteam.org',
        }
